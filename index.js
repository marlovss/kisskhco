			...
			catalogs: [
				{
					...
					type: 'asian',
					name: defaults.name,
					genres: ['series', 'movie', 'anime'],
					extra: [{ name: 'genres' , options: [ "South Korea", "Chinese","Thailand","Japanese","Hong Kong","Taiwan"]}, { name: 'skip' }, { name: 'search' }]
				}
			]
		}
	}
